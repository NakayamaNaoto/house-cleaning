...
export const leadMessage: LeadMessage = {
  ...
  subtitle: [
    'ハウスクリーニングのプロがLINE一本で、',
    '無料見積もりから出張対応まで一括対応いたします！',
  ],
}
...
export const pointCards: PointCard[] = [
  {
    ...
    title: ['水回り汚れを根本から除去'],
    body: [
      '美しさを取り戻したキッチンや水回りが直ぐに汚れてしまわぬよう、「根本の汚れ除去」を基本としたハウスクリーニングを提供しております。',
    ],
  ...
  },
  {
    ...
    body: [
      'お掃除代行はお客様の大切なご自宅に伺う為、55リフォーム名古屋では腕の良さはもちろんのこと、お客様から安心される人柄の良いスタッフだけをご用意しております。',
    ],
  ...
  },
  {
    ...
    body: [
      '一言にお掃除代行といっても、水回りやキッチン、エアコン清掃など多岐にわたりますので各所専門のプロが対応させていただきます。',
    ],
...
export const planCards: PlanCard[] = [
  {
    ...
    subtitle: 'お掃除代行3点セット',
    body: [
      '【レンジフード、キッチン 、浴室、お掃除機能付きエアコン】から2点、【トイレ、洗面台、通常エアコン】から1点、計3点お好きなクリーニング箇所をお選びいただけるお得なプランです。',
    ],
  ...
  },
  {
    ...
    subtitle: '水回り5点セット',
    body: [
      'レンジフード（換気扇）、キッチン 、浴室、洗面台、トイレの水回り5箇所をまとめてお掃除するお得なお掃除代行プランです。',
      '※作業時間目安は6時間程度の想定となります。',
    ],
...
export const gridCards: GridCard[] = [
  {
    title: '見出しが入ります',
    body:
      'サンプルテキストサンプルテキストサンプルテキストサンプルテキストサンプルテキストサンプト',
